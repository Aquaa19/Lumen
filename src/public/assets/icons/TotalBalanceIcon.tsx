...
interface TotalBalanceIconProps {
  size?: number;
}

const TotalBalanceIcon: React.FC<TotalBalanceIconProps> = ({ size = 24 }) => {
  return (
    <Svg width={size} height={size} viewBox="0 0 128 128" fill="none">
      <G fill="none">
        ...
        <Path d="M71.16 48.99c-12.67 27.06-14.85 61.23-14.85 61.23" stroke="#6B4B46" strokeWidth="5" strokeMiterlimit="10" />
