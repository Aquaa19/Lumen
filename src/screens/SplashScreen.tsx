...
export const SplashScreen: React.FC<{ navigation: any }> = ({ navigation }) => {
  ...
  return (
    <BackgroundLayout>
      ...
      <GlowOrb size={350} color="#3B82F6" opacity={0.15} style={{ top: '25%', alignSelf: 'center' }} />
      ...
      <View className="flex-1 justify-between items-center py-12 px-6 z-10 w-full">
        ...
        <View className="items-center justify-center flex-1">
          ...
          <Animated.View style={{ opacity: textOpacity }}>
            <Text className="mt-8 font-display-lg text-display-lg text-primary tracking-tight text-center">
              STUDENTSPEND
            </Text>
          </Animated.View>
        </View>
        ...
        <Animated.View style={{ opacity: textOpacity }} className="items-center flex-row gap-2 opacity-60">
          ...
          <Text className="font-label-caps text-label-caps text-on-surface-variant tracking-widest uppercase">
            securely encrypted
          </Text>
        </Animated.View>
      </View>
